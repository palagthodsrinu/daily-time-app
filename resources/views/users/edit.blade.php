...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold mb-1 text-dark">Edit User</h2>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('employee_type') is-invalid @enderror" 
                                ...
                                <option value="fulltime" {{ old('employee_type', $user->employee_type) == 'fulltime' ? 'selected' : '' }}>Full Time</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('doj') is-invalid @enderror" 
                                   id="doj" name="doj" value="{{ old('doj', $user->doj ? $user->doj->format('Y-m-d') : '') }}">
                            @error('doj')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (passwordInput) {
        ...
        passwordInput.addEventListener('input', function() {
            ...
            if (password.length === 0) {
                ...
                passwordFeedback.innerHTML = '<i class="fas fa-info-circle me-1"></i> Leave blank to keep current password';
    ...
    if (confirmPasswordInput && passwordInput) {
        ...
        passwordInput.addEventListener('input', function() {
            if (this.value && confirmPasswordInput.value && confirmPasswordInput.value !== this.value) {
                confirmPasswordInput.classList.add('is-invalid');
                confirmPasswordInput.classList.remove('is-valid');
            } else if (this.value && confirmPasswordInput.value) {
